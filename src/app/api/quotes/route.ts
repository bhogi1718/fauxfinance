...
import { SUPPORTED_SYMBOLS, type Symbol, isSupportedSymbol } from "@/lib/trading/constants";
...
export async function GET(req: Request) {
  ...
  const symbols: Symbol[] = requested.length ? requested.filter(isSupportedSymbol) : SUPPORTED_SYMBOLS;
